...
def process_song_file(cur, filepath):
    """Process and load data from a song file to the database.
    Args:
...
def process_log_file(cur, filepath):
    """Process and load data from a log file to the database.
    Args:
        cur: the cursor object.
...
def process_data(cur, conn, filepath, func):
    """Process and load data recursively from location specified by filepath.
    Args:
        cur: the cursor object.
        conn: the connection object.
        filepath: path to the dicectory wiht files.
        func: function used for file processing.
    Returns:
        None
    """
